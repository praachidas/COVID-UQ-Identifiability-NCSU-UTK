% function with state equations for ode system (first time period)

function dy = casehosp_odes_varybeta1(t,y,P)
...
% % E0 = 1.6102
% % mu = 0.05;
% mu = 0.01; %actual estimation with real data gives mu = 0.05 (stuck on bounds)
...
%number of new cases
dy(8) = kappa*I; % y(8) = integral(kappa*I)
